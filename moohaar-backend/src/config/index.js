...
const config = {
  ...
  CACHE_TTL_THEME: parseInt(process.env.CACHE_TTL_THEME || '60'),
  CACHE_TTL_CONTEXT: parseInt(process.env.CACHE_TTL_CONTEXT || '30'),
  CACHE_TTL_HEALTH: parseInt(process.env.CACHE_TTL_HEALTH || '5'),
